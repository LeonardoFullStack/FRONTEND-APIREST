...
var _require = require('../helpers/fetch'),
  consulta = _require.consulta,
  consulta2 = _require.consulta2;
var jwt = require('jsonwebtoken');
var cookieParser = require('cookie-parser');
var mostrarAdmin = function mostrarAdmin(req, res) {
  res.render('admin/index', {
    titulo: 'Práctica node',
    msg: 'Has accedido como administrador'
  });
};
var mostrarServicios = /*#__PURE__*/function () {
  ...
  return function mostrarServicios(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var mostrarUnServicio = /*#__PURE__*/function () {
  ...
  return function mostrarUnServicio(_x3, _x4) {
...
var editar = /*#__PURE__*/function () {
  ...
  return function editar(_x7, _x8) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          id = req.params.id;
          _context5.next = 3;
          return consulta2(id, 'put', req.body);
        case 3:
...
var post = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var _req$body, descripcion, servicio, respuesta;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _req$body = req.body, descripcion = _req$body.descripcion, servicio = _req$body.servicio;
        ...
        case 5:
          _context6.next = 7;
          return consulta2('', 'post', req.body);
        case 7:
  ...
  return function post(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
var ajustarFecha = function ajustarFecha(fecha) {
...
var validar = function validar(req, res, next) {
  var xtoken = req.cookies.xtoken;
  try {
    var payload = jwt.verify(xtoken, 'esta es la frasecilla');
  } catch (error) {
    res.render('error', {
      error: error,
...
module.exports = {
  ...
  mostrarUnServicio: mostrarUnServicio,
  eliminar: eliminar,
  editar: editar,
  put: put,
  crear: crear,
  post: post,
  ajustarFecha: ajustarFecha,
  validar: validar,
  logout: logout
};