...
var _require2 = require('./adminController'),
  ajustarFecha = _require2.ajustarFecha;
var path = require('path');
var _require3 = require('../helpers/scrapping'),
  webScraping = _require3.webScraping;
...
var comprobar = /*#__PURE__*/function () {
  ...
  return function comprobar(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var getStaticPage = function getStaticPage(req, res) {
  res.render('staticServices', {
    titulo: 'Servicios estáticos',
    msg: 'Aquí los servicios estáticos'
  });
};
var getDinamicPage = /*#__PURE__*/function () {
  ...
  return function getDinamicPage(_x7, _x8) {
